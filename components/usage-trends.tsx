          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              <div className="space-y-1">
                ...
                <div className="text-xs text-muted-foreground">450 porsi minggu ini</div>
              </div>
            ...
            <div className="flex justify-between items-center">
              <div className="space-y-1">
                ...
                <div className="text-xs text-muted-foreground">350 porsi minggu ini</div>
              </div>
            ...
            <div className="flex justify-between items-center">
              <div className="space-y-1">
                ...
                <div className="text-xs text-muted-foreground">300 porsi minggu ini</div>
              </div>
            ...
            <div className="flex justify-between items-center">
              <div className="space-y-1">
                ...
                <div className="text-xs text-muted-foreground">250 porsi minggu ini</div>
              </div>
            ...
            <div className="flex justify-between items-center">
              <div className="space-y-1">
                ...
                <div className="text-xs text-muted-foreground">150 porsi minggu ini</div>
              </div>
