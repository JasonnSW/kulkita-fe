  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Prediksi Kebutuhan</h1>
          <p className="text-muted-foreground">Perencanaan stok bahan segar berdasarkan prediksi kebutuhan</p>
        </div>
