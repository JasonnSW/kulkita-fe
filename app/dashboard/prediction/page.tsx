...
import { SpoilageAlertDashboard } from "@/components/spoilage-alert-dashboard"
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Prediksi Pembusukan</h1>
          <p className="text-muted-foreground">Peringatan dini pembusukan bahan berdasarkan model prediksi</p>
        </div>
